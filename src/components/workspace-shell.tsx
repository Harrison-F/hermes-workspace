...
import { fetchClaudeAuthStatus as fetchHermesAuthStatus } from '@/lib/claude-auth'
...
import { ClaudeReconnectBanner as HermesReconnectBanner } from '@/components/claude-reconnect-banner'
